...
\begin{align}
L(Y_i=C_1, Y_i=C_2,..., Y_i=C_m|\theta) = \prod_{i=1}^N p_\theta(Y_i=C_m)
\end{align}

where $Y_i$ is observation $i$, $N$ is number of observations, and $C_m$ is 
class $m$.

The log-likelihood of equation 1 is:
\begin{align}
log L(Y_i=C_1, Y_i=C_2,..., Y_i=C_m) = \sum_{i=1}^N log p_\theta(Y_i=C_m)
\end{align}
...
# diabetes_df < commented this, do we need it?
